document.addEventListener('DomContentLoaded', () => {
	...
	const displayGrid = document.querySelector('.grid-desplay');
	...
	function dragDrop() {
		...
		if (isHorizontal && !newNotAllowedHorizontal.includes(shipLastId)) {
			...
			/*Siempre que el índice de la nave que está arrastrando
			no esté en la matriz newNotAllowedVertical. 
			Esto significa que a veces si arrastras el barco por su index-1 , 
			index-2 y así sucesivamente, el barco regresará a displayGrid.*/
